...
import 'package:islamic_app/features/home/presentation/views/widgets/juz_grid_view.dart';
...
class HomeView extends StatelessWidget {
    ...
    return BlocProvider(
      ...
      child: Column(
        children: [
          ...
          const Align(alignment: Alignment.centerLeft, child: Icon(Icons.menu)),
          const SizedBox(height: AppSize.s20),
          Align(
            ...
            builder: (context, selectedItem) {
              return Expanded(
                child: AnimatedSwitcher(
                  ...
                  child: _buildViewForSelectedItem(context, selectedItem),
                ),
              );
            },
          )
  ...
  Widget _buildViewForSelectedItem(BuildContext context, String selectedItem) {
    if (selectedItem == AppStrings.surah) {
      ...
      return const JuzGridView(key: ValueKey('JuzView'));
    } else {
      return const Center(
